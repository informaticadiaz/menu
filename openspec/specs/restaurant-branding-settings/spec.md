...
## Purpose
Gestión de los datos de branding del negocio (nombre, descripción, logo y paleta de color) por parte del admin, incluyendo la API de lectura/escritura y la UI del panel admin.
